...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFB9RWguMAFyzCLET//va7P6OtEwJW/AeUaCV36yLQA==
::YB416Ek+ZG8=
::
::
...
::=====================================================================================
::                                                                                    |
::  This script is for people who cannot spend money on a activation key for windows  |
::                                                                                    |
::                                                                                    |
::                                                                                    |
::=====================================================================================
...
echo:                                                                     
echo:             [4] Check Activation Status [vbs] (Basic)
echo:             [5] Check Activation Status [wmi] (Kinda Advanced)
echo:             __________________________________________________      
echo:                                                                     
echo:             [6] Extras                                               
echo:             [7] Read Me
...
if %_erl%==8 exit /b
if %_erl%==7 start https://pastebin.com/8q2qixy2 & goto :MainMenu
